...
[mainText, solverText] = productionTexts();
badSolver = "exportedState = export_toy_road_peak_state(exportInput, " + ...
...
requiredSolver = [ ...
    ...
    "exportedState = export_toy_road_peak_state(exportInput, context.output_root);", ...
    "eventState = advance_toy_road_event(eventState,", ...
...
exportAt = firstPosition(solverText, ...
    'exportedState = export_toy_road_peak_state(exportInput, context.output_root);');
eventAt = firstPosition(solverText, 'eventState = advance_toy_road_event(eventState,');
