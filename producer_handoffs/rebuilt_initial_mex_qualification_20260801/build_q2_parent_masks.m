...
maskArtifact = orderfields(struct( ...
    'schema_version', 'rebuilt_initial_mex_q2_parent_masks_v2', ...
    ...
    char(parentReceipt.replay_source_mesh_sha256), ...
    'replay_source_mesh_sha256_semantics', ...
    char(parentReceipt.replay_source_mesh_sha256_semantics), ...
    'parent_vtk_mesh_sha256', char(parentReceipt.parent_vtk_mesh_sha256), ...
    'parent_vtk_mesh_sha256_semantics', ...
    char(parentReceipt.parent_vtk_mesh_sha256_semantics), ...
...
required = {'schema_version', 'status', 'blockers', ...
    ...
    'parent_cycle1_sha256', 'mesh_ordering_sha256', ...
    'replay_source_mesh_sha256', ...
    'replay_source_mesh_sha256_semantics', 'parent_vtk_mesh_sha256', ...
    'parent_vtk_mesh_sha256_semantics', 'num_elem', 'fields'};
if ~isstruct(receipt) || ~all(isfield(receipt, required)) || ...
        ~strcmp(receipt.schema_version, 'rebuilt_initial_mex_q2_parent_receipt_v2') || ...
...
updateText(md, artifact.replay_source_mesh_sha256);
updateText(md, artifact.replay_source_mesh_sha256_semantics);
updateText(md, artifact.parent_vtk_mesh_sha256);
updateText(md, artifact.parent_vtk_mesh_sha256_semantics);
