...
function localThrowPredicate(receipt)
row = receipt.predicates(end);
if ~row.pass
    error('toyRoadD1:PredicateFailed', ...
        'D1 runtime predicate failed: %s', row.name);
end
end
