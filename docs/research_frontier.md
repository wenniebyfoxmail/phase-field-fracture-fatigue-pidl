...
- RRaPINN G4 的离线 prerequisites 与 bounded Taobo A smoke 已通过：step301--305 exact replay、step304 true residual、boundary trace 和 external runtime 均获独立 tooling-only 批准；B 未执行。c82/c83 exact-peak FEM、完整 A/B runtime/sealed metrics 与 archive routing 修复仍缺失，因此 G4 launch 和 U0.13/U0.11 继续 blocked。详见 `docs/experiments/rrapinn_residual_risk_training_track.md`。
