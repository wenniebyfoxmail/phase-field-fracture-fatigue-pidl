...
2. **Hard-recovery c89 field mechanism** (supporting diagnostic) — PIDL can match FEM `N_f=89` while failing active-driver/process-zone/history co-location. Keep the residual-stiffness micro-run separate from the reality-assimilation claim; a forward PIDL scalar or field fix does not validate deployment observability. Artifacts: `docs/pidl_fem_clear_comparison_board_2026-07-07.md`, local `analysis/residual_stiffness_code_path_gate_20260710/decision.md`.
