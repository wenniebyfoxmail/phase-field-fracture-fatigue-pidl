...
- RRaPINN G4 仅完成离线 prerequisites qualification：future-free c60 restart、true-residual/boundary hooks、固定 lambda 审计、contained-only projector 与 blind contracts 已通过；c82/c83 exact-peak FEM、Taobo A replay/真实 hook/runtime 仍缺失，因此 G4 launch 和 U0.13/U0.11 继续 blocked。详见 `docs/experiments/rrapinn_residual_risk_training_track.md`。
