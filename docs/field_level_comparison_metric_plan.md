...
This requires the full reverseBC `u12` `.mat` handoff to be present locally
again or regenerated by the FEM agent. Until this exists, femAnchorBC can be
scored strictly but reverseBC remains only visually/partially scored.
